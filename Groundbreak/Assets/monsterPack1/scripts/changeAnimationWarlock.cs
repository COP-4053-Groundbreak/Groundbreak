...
public class changeAnimationWarlock : MonoBehaviour {
	...
	public int numberOfAnimations = 6;
	int actualAnimation;
	...
	void OnGUI(){
		...
		if (GUI.Button (new Rect (Screen.width *0.74f, Screen.height * 0.8f, Screen.width * 0.15f, Screen.height * 0.1f), "Change to next animation")) {
			changeAnimation ();
		}
	}
