...
public class RoomManager : MonoBehaviour
{
    public void ToggleRoom(bool whatToSet) 
    {
        ...
        if ((SceneManager.GetActiveScene().name == "Level 1" && gameObject.name != "StartRoomV2") ||
            (SceneManager.GetActiveScene().name == "Level2" && gameObject.name != "StartRoomLevel2") ||
            (SceneManager.GetActiveScene().name == "Tutorial" && gameObject.name != "R"))
        {
